  ...
  return (
    ...
    <section className='container mt-52'>
      <div className='text-center'>
        <p className='text-white sm:text-5xl lg:text-7xl font-bold text-center'>Aptos! layer 1 for everyone</p>
          ...
          <div className='bg-[#1DE9B6] rounded-md shadow-md shadow-slate-600 w-full mt-32 h-32 items-center px-4'>
            <div className='flex justify-between items-center'>
              ...
              <div className='hidden md:flex'>
                <button className='text-black'>Read more <i class="ri-arrow-right-fill"></i></button>
              </div>
            </div>
          </div>
