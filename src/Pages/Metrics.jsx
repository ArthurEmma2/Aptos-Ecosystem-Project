...
function Metrics() {
  return (
    ...
    <div className=''>
        ...
        <p className='text-[#90E6D1] opacity-70 text-5xl lg:text-5xl mt-6 font-extrabold tracking-[2px]'>Aptos more cares about<br /> delivering all the <br />ecosystem metrics</p>
